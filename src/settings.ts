...
export class HomeTabSettingTab extends PluginSettingTab{
    ...
    display(): void{
        ...
        if(Platform.isMobile){
            containerEl.createEl('h2', {text: 'Mobile'});
            new Setting(containerEl)
                .setName('Custom tabs overview')
                .setDesc('Use a Safari-like tabs overview with zoom animation instead of Obsidian\'s built-in switcher.')
                .addToggle(toggle => toggle
